...
const videoStyle = 'justify-self-center w-3xl rounded-2xl max-sm:w-90'
...
function  AboutSection() {
    return(
            ...
            <section id="about" className="bg-black text-center pt-10 pb-35 sm:pb-20 max-sm:pb-15 ">
                ...
                <button className=" hover:text-white bg-transparent px-10 py-2 text-largeParagraph rounded-full border-2 border-green font- mt-10 hover:scale-110 hover:bg-green text-green hover:border-white sm:text-mobileParagraph font-secondary max-sm:text-[14px]"><a href="/Calendar">Book A Call!</a></button>
            </section>
    )
}
