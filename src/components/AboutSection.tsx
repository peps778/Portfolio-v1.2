...
function  AboutSection() {
    return(
            ...
            <section id="about" className="bg-black text-center pt-10 pb-35 sm:pb-20    ">
                ...
                <p className="text-white lg:text-largeParagraph sm:text-mobileParagraph sm:mx-7 mb-20 sm:mt-10 ">I’m Paul Jhon Magbanua, a Front-End Developer skilled in coding, CMS, <br /> automation, and CRM management (GoHighLevel). I deliver efficient, creative, <br />and results-driven digital solutions.</p>
                ...
                <button className="text-white bg-green px-10 py-2 text-largeParagraph rounded-full border-2 border-white font-bold mt-10 hover:scale-110 hover:bg-primary hover:text-green hover:border-green sm:text-mobileParagraph"><a href="/Contact">Book A Call!</a></button>
            </section>
    )
}
